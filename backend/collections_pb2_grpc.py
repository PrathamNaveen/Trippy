...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in collections_pb2_grpc.py depends on'
...
class CollectionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DeleteCollection = channel.unary_unary(
                ...
                request_serializer=collections__pb2.DeleteCollectionRequest.SerializeToString,
...
def add_CollectionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'DeleteCollection': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=collections__pb2.DeleteCollectionRequest.FromString,
                    response_serializer=collections__pb2.DeleteCollectionResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'CollectionService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('CollectionService', rpc_method_handlers)
...
class CollectionService(object):
    ...
    def DeleteCollection(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/CollectionService/DeleteCollection',
            collections__pb2.DeleteCollectionRequest.SerializeToString,
